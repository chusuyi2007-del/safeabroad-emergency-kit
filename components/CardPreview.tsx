...
export function CardPreview({
  ...
  return (
    <article
      className="card-export flex min-h-72 flex-col justify-between rounded-md border border-line p-5 shadow-sm"
      id={exportId}
    >
      <div>
        <p className="text-sm font-bold uppercase tracking-wide text-calm">{card.title}</p>
        <p className="mt-4 text-xl font-semibold leading-8 text-ink">{card.english}</p>
        <p className="mt-4 border-t border-line pt-4 text-base leading-7 text-gray-700">{card.chinese}</p>
